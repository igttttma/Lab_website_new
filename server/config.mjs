...
export const serverConfig = {
  ...
  blimpmateAgentUrl: (process.env.BLIMPMATE_AGENT_URL || 'http://127.0.0.1:5050').replace(/\/$/, ''),
  blimpmateAgentTimeoutMs: Math.max(250, Math.min(30000, Number(process.env.BLIMPMATE_AGENT_TIMEOUT_MS || 30000) || 30000)),
  blimpmateAgentMaxRequestBytes: Math.max(256000, Math.min(25000000, Number(process.env.BLIMPMATE_AGENT_MAX_REQUEST_BYTES || 8500000) || 8500000)),
  blimpmateAgentDemoFallback: process.env.BLIMPMATE_AGENT_DEMO_FALLBACK !== 'false',
